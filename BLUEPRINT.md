...
| [S-003 - v3.2.0 Upgrade And Project Validation](workbench/specs/S-003-v3-2-0-upgrade-and-project-validation/SPEC.md) | Upgrade the reference room to v3.2.0 and prove a useful fresh project before reviewed integration. | complete |
<!-- spec-catalog:end -->
